...
class ProtocolInterfaceTest {
    ...
    private fun click(text: String) {
        ...
        if (text in listOf("Save protocol", "Save item")) node.performClick() else node.performScrollTo().performClick()
    ...
    @Test fun multiPeptideAgendaCompletionRevisionAndBackup() {
        ...
        waitText("Today.")
        agenda("Mark done")
        compose.onAllNodesWithText("Mark done")[0].performScrollTo().performClick()
